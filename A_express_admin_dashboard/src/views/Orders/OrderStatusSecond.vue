<template>
      ...
      <form action="" class="w-[20%]">
        <label for="comment" class="">
          ...
          <input type="text" name="comment" v-model="comment" :disabled="status == 3" id="comment"
            ...
            class="w-full focus:outline-none h-[50px] dark:text-white dark:bg-transparent border-[2px] border-gray-300 rounded-[3px] focus:ring-0" />
        </label>
  ...
  <section class="bg-[#ffffff9c] backdrop-blur-[6px] dark:bg-gray-900 mt-[26px] sm:p-5">
    <div class="w-full">
      <!-- Start coding here -->
      <div class="bg-[#ffffff9c] backdrop-blur-[6px] dark:bg-gray-800 relative sm:rounded-lg overflow-hidden">
  ...
  <button @click="() => $router.push({ path: '/neworder' })"
